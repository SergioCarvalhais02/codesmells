...
public class Tree {
    ...
    public String toString() {
        return "Tree planted at " + this.plantedAt.toString() + " in location " + this.location.getLocationLatitude() + "," + this.location.getLocationLongitude() + " (" + this.location.getLocationName() + ")";
    }
